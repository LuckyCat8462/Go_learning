...
var fileDescriptor_4c9e10cf24b1156d = []byte{
	...
	0xac, 0x41, 0x20, 0xa6, 0x91, 0x1e, 0x17, 0x47, 0x70, 0x62, 0xa5, 0x47, 0x6a, 0x4e, 0x4e, 0xbe,
	0x90, 0x12, 0x12, 0x9b, 0x4b, 0xaf, 0x20, 0x49, 0x0f, 0x62, 0x92, 0x14, 0x12, 0x3b, 0x89, 0x0d,
	0x6c, 0x95, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xe1, 0x4b, 0xc1, 0x59, 0x7a, 0x00, 0x00, 0x00,
}
...
func (c *sayHelloClient) SayHello(ctx context.Context, in *Person, opts ...grpc.CallOption) (*Person, error) {
	out := new(Person)
	err := c.cc.Invoke(ctx, "/pb.SayHello/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SayHello_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.SayHello/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayHelloServer).SayHello(ctx, req.(*Person))
	}
